const themeList = [
    ...
    "How should success be measured? And by that me…ment, who is the most successful person you know?",
    ...
    "What was the best period of your life so far? …hink will be the best period of your entire life?",
    ...
    "What’s the best pet name you can come up with …cific type of pet? (Like these orange cat names.)",
    ...
    "Who would be the worst person to be stuck in a… the best person to be stuck in an elevator with?",
    ...
    "What was the worst book you had to read for s…w about the best book you had to read for school?",
    ...
    "Records, tapes, CDs, MP3s, streaming. Which d…ou grow up with? What is good and bad about each?",
    ...
    "Do you play sports video games? Which ones? I…he video game or playing the sport more fun? Why?",
    ...
    "Can you think of any technology that has only…f technology that has only made the world better?",
    ...
    "Who do you think has the biggest impact on fa…sses, musicians, fashion designers, or consumers?",
    ...
    "Is it better to live where there are four sea…ns or where one season takes up most of the year?",
    ...
    "If some of the lesser-known holidays were com…ized, what would the commercialization look like?",
    "If you could make a holiday, what would it be…d it have? What would people eat on your holiday?",
    ...
    "Does the government have a place in regulatin…? To what extent should government regulate food?",
    "When people make mistakes about food (especia…em? (i.e. sushi / sashimi or stromboli / calzone)",
    ...
    "The world has become infested with rabid dogs…re do you hole up to survive the “a-pup-calypse”?",
    "A portal to another world opens in front of y…to get back after you go through. What do you do?",
    ...
    "If you could switch two movie characters, what…itch would lead to the most inappropriate movies?",
    "What inanimate object would be the most annoyi… if it played loud upbeat music while being used?",
    "When did something start out badly for you but in the end, it was great?",
    "How would your country change if everyone, regardless of age, could vote?",
    "What animal would be cutest if scaled down to the size of a cat?",
    "If your job gave you a surprise three day paid…uperate, what would you do with those three days?",
    "What’s wrong but sounds right?",
    "What’s the most epic way you’ve seen someone quit or be fired?",
    "If you couldn’t be convicted of any one type o…t criminal charge would you like to be immune to?",
    ...
    "In the past people were buried with the items …ed with you so you could use it in the afterlife?",
    ...
    "If you were given a PhD degree, but had no mor…w, what degree would you want to be given to you?",
    ...
    "If you were moving to another country, but cou…pack one carry-on sized bag, what would you pack?",
    ...
    "If you could have an all-expenses paid trip to… world monument, which monument would you choose?",
    ...
    "If you were given five million dollars to open…all museum, what kind of museum would you create?",
    ...
    "As a child, what did you think would be aweso… but isn’t as awesome as you thought it would be?",
    ...
    "What actors or actresses can’t play a differe…they played their most famous character too well?",
    ...
    "If you could know the truth behind every cons… that you knew the truth, would you want to know?",
    ...
    "If you were given one thousand acres of land … on but couldn’t sell, what would you do with it?",
    ...
    "What happens in your country regularly that p… in most countries would find strange or bizarre?",
    ...
    "If you had to disappear and start a whole new…, what would you want your new life to look like?",
    ...
    "If money and practicality weren’t a problem, …d be the most interesting way to get around town?",
    ...
    "If you had a HUD that showed three stats abou…d at, what three stats would you want it to show?",
    ...
    "Tear gas makes people cry and laughing gas ma…e, what other kinds of gases do you wish existed?",
    ...
    "What sport could you play the longest in a te…ne discovering you aren’t a professional athlete?",
    "If you could talk to animals and they would u…derstand them, what would you do with that power?",
    ...
    "What story you’ve heard has stayed with you a…lways disturbs you every time you think about it?",
    ...
    "If you could airdrop anything you want, worth…would you airdrop and where would you airdrop it?",
    ...
    "What do a lot of people have very strong opin…bout, even though they know very little about it?",
    ...
    "Would you want the ability to hear the though…le near you if you couldn’t turn the ability off?",
    ...
    "If you were given unlimited resources, how wo…st of humanity into one stadium at the same time?",
    ...
    "What piece of “art” would you create if you h…o be an artist and submit something to a gallery?",
    "What do you do to make the world a better place?",
    "What’s the best and worst thing about the country you are from?",
    "If you were in charge renaming things so that…more accurate, what names would you come up with?",
    ...
    "If you were hired to show tourists what life …ou live, what would you show them / have them do?",
    ...
    "What does the opposite sex do that you wish t…tomically feasible or it’s socially frowned upon?",
    ...
    "What was the last situation where some weird … you were crazy or everyone around you was crazy?",
    ...
    "If you wanted to slowly drive a roommate insa…t kind of notes would you leave around the house?",
    ...
    "What songs do you feel compelled to sing alon…em, even if you don’t totally know all the words?",
...
document.addEventListener('DOMContentLoaded', function () {
    document.getElementById("themeButton")
        .addEventListener('click', selectRandomTheme);
});


function selectRandomTheme() {

    let index = (Math.round(Math.random() * (themeList.length - 1)));
    console.log("index="+index)
    console.log("theme="+themeList[index])
    document.getElementById("themeLabel").value = themeList[index]
}
